...
private:
  ...
  void createGraphicsPipeline()
  {
    ...
    VkPipelineVertexInputStateCreateInfo vertesInputInfo{};
    auto bindingDescription = Vertex::getBindingDescription();
    auto attributeDescriptions = Vertex::getAttributeDescriptions();
    vertesInputInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO;
    vertesInputInfo.vertexBindingDescriptionCount = 1;
    vertesInputInfo.vertexAttributeDescriptionCount = static_cast<uint32_t>(attributeDescriptions.size());
    vertesInputInfo.pVertexBindingDescriptions = &bindingDescription;
    vertesInputInfo.pVertexAttributeDescriptions = attributeDescriptions.data();
    ...
    pipelineInfo.pVertexInputState = &vertesInputInfo;
  ...
  bool isDeviceSuitable(VkPhysicalDevice device)
  {
    ...
    return deviceProperties.deviceType == VK_PHYSICAL_DEVICE_TYPE_DISCRETE_GPU and
           deviceFeatures.geometryShader and indices.IsComplete() and
           extensionsSupported and swapChainAdequate;
  }
